namespace Shared
{
    public static class CelestialCoordinates
    {
        ...
        public static Coordinates CalculateHorizontalCoordinatesMoon(DateTime time, double _longitude, double _latitude)
        {

            //Convert the latitude to radians
            _latitude *= Deg2Rad;

            double lw = Deg2Rad * _longitude * -1;
            DateTime epoch = new DateTime(2000, 1, 1, 12, 0, 0);
            TimeSpan j2000TS = time - epoch;
            double j2000 = j2000TS.TotalDays;

            double L = Deg2Rad * (218.316f + 13.176396f * j2000), // ecliptic longitude
            M = Deg2Rad * (134.963f + 13.064993f * j2000), // mean anomaly
            F = Deg2Rad * (93.272f + 13.229350f * j2000),  // mean distance

            l = L + Deg2Rad * 6.289f * Math.Sin(M), // longitude
            b = Deg2Rad * 5.128f * Math.Sin(F),     // latitude
            dt = 385001f - 20905f * Math.Cos(M);  // distance to the moon in km

            //Calculate the Right ascension and declinaison of the moon
            double e = Deg2Rad * 23.4397f;
            ...
            //Sidereal time
            double HA = (Deg2Rad * (280.16f + 360.9856235f * j2000) - lw) - ra;
        ...
        public static Coordinates CalculateHorizontalCoordinatesPlanets(DateTime time, double _longitude, double _latitude, Planets _name)
        {
            ...
            double inclinationE = (0.00005f - 46.94f * cJ2000 / 3600.0f) * Deg2Rad; ;
            double longNodeE = (-11.26064f - 18228.25f * cJ2000 / 3600.0f) * Deg2Rad; ;
            double longPeriE = (102.94719f + 1198.28f * cJ2000 / 3600.0f) * Deg2Rad;
            double meanDistE = 1.00000011f - 0.00000005f * cJ2000;
            double eccenctricityE = 0.01671022f - 0.00003804f * cJ2000;
            double meanLongE = Mod2Pi((100.46435f + 129597740.63f * cJ2000 / 3600.0f) * Deg2Rad);
            ...
            switch (_name)
            {
                ...
                case Planets.Mercury:
                    inclination = (7.00487f - 23.51f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (48.33167f - 446.30f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (77.45645f + 573.57f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 0.38709893f + 0.00000066f * cJ2000;
                    eccentricity = 0.20563069f + 0.00002527f * cJ2000;
                    meanLong = Mod2Pi((252.25084f + 538101628.29f * cJ2000 / 3600.0f) * Deg2Rad);
                    break;
                case Planets.Venus:
                    inclination = (3.39471f - 2.86f * cJ2000 / 3600.0f) * Deg2Rad;
                    longNode = (76.68069f - 996.89f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (131.53298f - 108.80f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 0.72333199f + 0.00000092f * cJ2000;
                    eccentricity = 0.00677323f - 0.00004938f * cJ2000;
                    meanLong = Mod2Pi((181.97973f + 210664136.06f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Mars:
                    inclination = (1.85061f - 25.47f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (49.57854f - 1020.19f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (336.04084f + 1560.78f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 1.52366231f - 0.00007221f * cJ2000;
                    eccentricity = 0.09341233f + 0.00011902f * cJ2000;
                    meanLong = Mod2Pi((355.45332f + 68905103.78f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Jupiter:
                    inclination = (1.30530f - 4.15f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (100.55615f + 1217.17f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (14.75385f + 839.93f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 5.20336301f + 0.00060737f * cJ2000;
                    eccentricity = 0.04839266f - 0.00012880f * cJ2000;
                    meanLong = Mod2Pi((34.40438f + 10925078.35f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Saturn:
                    inclination = (2.48446f + 6.11f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (113.71504f - 1591.05f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (92.43194f - 1948.89f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 9.53707032f - 0.00301530f * cJ2000;
                    eccentricity = 0.05415060f - 0.00036762f * cJ2000;
                    meanLong = Mod2Pi((49.94432f + 4401052.95f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Uranus:
                    inclination = (0.76986f - 2.09f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (74.22988f - 1681.40f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (170.96424f + 1312.56f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 19.19126393f + 0.00152025f * cJ2000;
                    eccentricity = 0.04716771f - 0.00019150f * cJ2000;
                    meanLong = Mod2Pi((313.23218f + 1542547.79f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Neptune:
                    inclination = (1.76917f - 3.64f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (131.72169f - 151.25f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (44.97135f - 844.43f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 30.06896348f - 0.00125196f * cJ2000;
                    eccentricity = 0.00858587f + 0.00002510f * cJ2000;
                    meanLong = Mod2Pi((304.88003f + 786449.21f * cJ2000 / 3600f) * Deg2Rad);
                    break;
                case Planets.Pluto:
                    inclination = (17.14175f + 11.07f * cJ2000 / 3600f) * Deg2Rad;
                    longNode = (110.30347f - 37.33f * cJ2000 / 3600f) * Deg2Rad;
                    longPeri = (224.06676f - 132.25f * cJ2000 / 3600f) * Deg2Rad;
                    meanDist = 39.48168677f - 0.00076912f * cJ2000;
                    eccentricity = 0.24880766f + 0.00006465f * cJ2000;
                    meanLong = Mod2Pi((238.92881f + 522747.90f * cJ2000 / 3600f) * Deg2Rad);
                    break;
            }
            ...
            double ecl = 23.439281f * Deg2Rad;
            double xeq = xg;
            double yeq = yg * Math.Cos(ecl) - zg * Math.Sin(ecl);
            double zeq = yg * Math.Sin(ecl) + zg * Math.Cos(ecl);

            // find the RA and DEC from the rectangular equatorial coords
            double ra = Mod2Pi(Math.Atan2(yeq, xeq)) * Rad2Deg;
            double dec = Math.Atan(zeq / Math.Sqrt(xeq * xeq + yeq * yeq)) * Rad2Deg;
        ...
        public static Coordinates CalculateHorizontalCoordinatesStar(DateTime time, double _longitude, double _latitude, float _ra, float _dec)
        {
